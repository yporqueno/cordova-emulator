...
(function init(platform) {
	navigator.__defineGetter__('platform', function(){return 'MacIntel';});
	navigator.__defineGetter__('userAgent', function(){return '"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36"';});
	...
	navigator.__defineGetter__('appVersion', function(){return '5.0 (Macintosh; Intel Mac OS X 10_9_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36';});
